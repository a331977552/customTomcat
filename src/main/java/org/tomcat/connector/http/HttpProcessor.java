...
import org.tomcat.core.ServletProcessor;
...
public class HttpProcessor {
	...
	static StringManager sm=StringManager.getManager(HttpProcessor.class.getPackage().getName());
	HttpRequest request;
	...
	public void process(Socket socket) {
		try {
			...
			if(request.getRequestURI().startsWith("/servlet/")) {
				...
				processor.process(request, httpResponse);
			}else {
